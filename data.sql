...
INSERT IGNORE INTO detailCount (date, provinceName, currentConfirmedCount, confirmedCount, deadCount, curedCount) VALUES
('2022-05-03', '香港', 261751, 330725, 9313, 59661),
('2022-05-03', '台湾', 136198, 150808, 868, 13742),
('2022-05-03', '上海市', 16716, 59070, 461, 41893),
('2022-05-03', '吉林省', 1209, 40242, 5, 39028),
('2022-05-03', '浙江省', 793, 3111, 1, 2317),
('2022-05-03', '北京市', 345, 2191, 9, 1837),
('2022-05-03', '黑龙江省', 247, 2952, 13, 2692),
('2022-05-03', '江西省', 233, 1371, 1, 1137),
('2022-05-03', '广东省', 180, 7082, 8, 6894),
('2022-05-03', '四川省', 70, 2057, 3, 1984),
('2022-05-03', '山东省', 68, 2722, 7, 2647),
('2022-05-03', '内蒙古自治区', 59, 1751, 1, 1691),
('2022-05-03', '福建省', 47, 3022, 1, 2974),
('2022-05-03', '江苏省', 43, 2206, 0, 2163),
('2022-05-03', '河南省', 39, 2907, 22, 2846),
('2022-05-03', '辽宁省', 36, 1646, 2, 1608),
('2022-05-03', '山西省', 29, 418, 0, 389),
('2022-05-03', '云南省', 28, 2119, 2, 2089),
('2022-05-03', '湖南省', 28, 1385, 4, 1353),
('2022-05-03', '海南省', 26, 288, 6, 256),
('2022-05-03', '青海省', 25, 95, 0, 70),
('2022-05-03', '广西壮族自治区', 21, 1587, 2, 1564),
('2022-05-03', '河北省', 14, 1998, 7, 1977),
('2022-05-03', '新疆维吾尔自治区', 8, 1007, 3, 996),
('2022-05-03', '安徽省', 7, 1065, 6, 1052),
('2022-05-03', '湖北省', 4, 68398, 4512, 63882),
('2022-05-03', '重庆市', 4, 698, 6, 688),
